...
function AdminLayout({ onLogout }) {
    ...
    const navLinks = [
        ...
        { to: '/participants', label: 'Participants', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
    ];

    if (isSuperadmin) {
        navLinks.push(
            { to: '/admins', label: 'Admins', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
            { to: '/results', label: 'Results', icon: 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
    ...
    const getPageTitle = (pathname) => {
        ...
        if (pathname.startsWith('/participants')) return 'Manage Participants';
        if (pathname === '/admins') return 'Manage Admins';
        if (pathname === '/results') return 'Test Results';
        if (pathname === '/security') return 'Security Dashboard';
        return 'Admin Panel';
    };
