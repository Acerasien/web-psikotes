...
PHASE_INSTRUCTIONS = {
    1: (
        ...
        "<br><br><b>Tugas Anda adalah:</b>"
        "<ul class='list-disc ml-5 mt-2 space-y-1 text-sm'>"
        "<li>Menentukan gambar yang tepat untuk melengkapi kotak kosong tersebut.</li>"
        "<li>Pilih satu jawaban yang paling sesuai (A - F).</li>"
        "<li>Pahami pola perubahan gambar sebelumnya sebelum menentukan jawaban.</li>"
        "</ul>"
    ),
    2: (
        ...
        "<br><br><b>Tugas Anda adalah:</b>"
        "<ul class='list-disc ml-5 mt-2 space-y-1 text-sm'>"
        "<li>Memilih 2 gambar yang memiliki kesamaan karakteristik atau pola.</li>"
        "<li>3 gambar lainnya merupakan pengecoh.</li>"
        "<li>Identifikasi kesamaan yang paling tepat di antara pilihan yang ada.</li>"
        "</ul>"
    ),
    3: (
        "Terdapat kotak besar berisi beberapa kotak kecil dengan pola tertentu. "
        "Kotak di bagian kanan bawah masih kosong (garis putus-putus). "
        "<br><br><b>Tugas Anda adalah:</b>"
        "<ul class='list-disc ml-5 mt-2 space-y-1 text-sm'>"
        "<li>Memilih satu jawaban yang paling tepat dari pilihan yang tersedia.</li>"
        "<li>Melengkapi bagian yang kosong berdasarkan pola yang ada.</li>"
        "</ul>"
    ),
    4: (
        "Perhatikan contoh soal. Setiap gambar memiliki karakteristik tertentu "
        "dan terdapat titik hitam tebal di dalamnya. "
        "<br><br><b>Tugas Anda adalah:</b>"
        "<ul class='list-disc ml-5 mt-2 space-y-1 text-sm'>"
        "<li>Mencari gambar yang memiliki karakteristik penempatan titik yang sama.</li>"
        "<li>Titik hitam bisa berada pada dua/beberapa objek sekaligus.</li>"
        "<li>Pilih satu gambar yang memenuhi syarat logika posisi titik tersebut.</li>"
        "</ul>"
    ),
    5: (
        "Sama seperti Fase 1, Anda akan melihat rangkaian gambar dalam urutan tertentu. "
        "<br><br><b>Tugas Anda adalah:</b>"
        "<ul class='list-disc ml-5 mt-2 space-y-1 text-sm'>"
        "<li>Menentukan gambar yang tepat untuk melengkapi kotak terakhir.</li>"
        "<li>Pilih satu jawaban yang paling sesuai (A - F).</li>"
        "<li>Gunakan logika pola yang telah Anda pelajari sebelumnya.</li>"
        "</ul>"
    ),
    6: (
        "Sama seperti Fase 2, Anda akan melihat lima gambar berdampingan. "
        "<br><br><b>Tugas Anda adalah:</b>"
        "<ul class='list-disc ml-5 mt-2 space-y-1 text-sm'>"
        "<li>Memilih 2 gambar yang memiliki kesamaan pola.</li>"
        "<li>Pastikan kedua gambar memiliki logika yang identik.</li>"
        "</ul>"
    ),
    7: (
        "Sama seperti Fase 3, terdapat kotak besar dengan bagian kanan bawah yang kosong. "
        "<br><br><b>Tugas Anda adalah:</b>"
        "<ul class='list-disc ml-5 mt-2 space-y-1 text-sm'>"
        "<li>Memilih gambar yang paling tepat untuk melengkapi matriks pola.</li>"
        "<li>Perhatikan hubungan horizontal dan vertikal pada pola tersebut.</li>"
        "</ul>"
    ),
    8: (
        "Sama seperti Fase 4, perhatikan posisi titik hitam pada gambar. "
        "<br><br><b>Tugas Anda adalah:</b>"
        "<ul class='list-disc ml-5 mt-2 space-y-1 text-sm'>"
        "<li>Cari gambar yang memiliki logika posisi titik hitam yang sama.</li>"
        "<li>Fokus pada hubungan antara titik dan bidang/garis di sekitarnya.</li>"
        "</ul>"
    ),
}
